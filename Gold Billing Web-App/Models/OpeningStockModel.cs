...
namespace Gold_Billing_Web_App.Models
{
    public class OpeningStockModel
    {
        ...
        // ItemName is for display only, no validation needed
        ...
        [Required(ErrorMessage = "Less is required")]
        ...
        [Required(ErrorMessage = "Wastage is required")]
        [Range(0, 100, ErrorMessage = "Wastage must be between 0 and 100")]
        public decimal Wastage { get; set; }

        [Required(ErrorMessage = "Total Weight percentage is required")]
        ...
        [Required(ErrorMessage = "Fine is required")]
